let iceandfire_ban_items_1789288014567 = [
...
let iceandfire_ban_wearables_1789288014567 = [
];
ItemEvents.tooltip(event => event.add(iceandfire_ban_items_1789288014567, Text.red("此物品无法使用")));
ItemEvents.tooltip(event => event.add(iceandfire_ban_wearables_1789288014567, Text.red("此物品无法使用")));
